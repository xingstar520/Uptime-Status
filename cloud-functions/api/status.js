/**
 * API 代理实现（新版腾讯云 EdgeOne Pages - Node.js 函数运行时）
 *
 * 该文件运行在 EdgeOne Pages 的 Node.js 函数运行时下：
 * - 路由：/cloud-functions/api/status.js -> /api/status
 * - 支持 ES2023+ 语法、npm 生态
 * - 通过导出 Function Handlers（onRequest / onRequestPost / onRequestOptions）注册路由
